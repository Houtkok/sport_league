...
<button type="button" id="backhome"><a href="/home"  style="color: white;">home</a></button> 
<div class='box'>
  <div class='box-form'>
      ...
      <div class='fieldset-body' id='login_form'>
        <button onclick="openLoginInfo();" class='b b-form i i-more' title='Mais Informações'></button>
          ...
          <label class='checkbox'>
        	...
        	<a href="/adminMode"><input type='submit' id='do_login' value='Access Admin Mode' title='Get Started' /></a>
      </div>
    </div>
  </div>
  <div class='box-info'>
