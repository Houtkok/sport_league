...
$navMenu = array(
    ...
    'Players' => array(
        'Top scorer' => 'players.php',
        'Top assist' => 'players.php',
        'best play of the season' => 'season',
    ),
    'Schedule' => 'schedule',
    'ticket' => array(
    'VIP Ticket' => 'ticket',
    'regular Ticket' =>'ticket',
    'Premium Ticket' => 'ticket',
    ),
    'Stadium' => array(
              ...
              <div class="carousel-inner" role="listbox">
                ...
                <img src="{{ URL('images/erling-haaland-fc-3840x2160-13049.jpeg')}}"  alt="">
                  <div class="carousel-caption">
                    ...
                    <p> Erling Haaland | Manchester City | 17 goals
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-md-8">
                <div class="popular">
                    ...
                    <p style="font-size: 20px">To buy tickets for football leagues, you typically follow these steps:
                        Visit the Official Website: <br>
                        Go to the official website of the football league or the respective team you want to watch. <br>
                        Navigate to the Tickets/Buy Tickets section. <br>
                        Choose the match and select seats.<br>
                        Add tickets to your cart and proceed to checkout.<br>
                        Provide payment details and complete the transaction.<br>
                        Receive confirmation via email.<br>
                        Collect/print tickets or use mobile ticketing.<br>
                        Arrive at the stadium with tickets for admission.
                    </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="my_form">
                    <form id="MyForm" action="ticket" method="POST">
                        ...
                        <div class="form-group">
                        <input type="radio" id="html" name="fav_language" value="VIP">
                        <label for="html">VIP Ticket</label><br>
                        <input type="radio" id="css" name="fav_language" value="regular">
                        <label for="css">regular Ticket</label><br>
                        <input type="radio" id="javascript" name="fav_language" value="premium">
