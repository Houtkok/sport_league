...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <!-- /.navbar -->
   ...
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="footballleagues" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Football Leagues</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/images/download.jpeg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">KAIRITH</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="adminMode" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="{{url('/nationals')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>National</p>
                </a>
              </li>
